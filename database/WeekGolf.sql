...
create table Users (
    ...
    email VARCHAR(320) NOT NULL UNIQUE, -- e-mail of the user
	...
	pp VARCHAR(64), -- Link to the profile picture
...
CREATE TABLE Golf (
	...
	nb_players INT UNSIGNED DEFAULT NULL, -- The number of players that there were
...
CREATE TABLE Suggestion (
	...
	color VARCHAR(7), -- Color of the language
...
CREATE TABLE Commentaire (
	...
	golf_id BIGINT UNSIGNED NOT NULL, -- On which solution it has been posted
    ...
    FOREIGN KEY (owner_id) REFERENCES Users(id),
    FOREIGN KEY (golf_id) REFERENCES Golf(id)
);
...
CREATE TABLE Activity (
	...
	activity_date DATETIME NOT NULL, -- When did this activity occur
...
CREATE TABLE UpvoteCommentaire (
