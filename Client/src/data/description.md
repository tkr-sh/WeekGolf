...
- [Vyxal](#vyxal)
  - [History](#history-30)
  - [Characteristics](#characteristics-30)
  - [Program](#program-30)
...
# F#
## History
F# is a multi-paradigm language (imperative, functional, concurrent and object-oriented) created at <a href="https://en.wikipedia.org/wiki/Google">MicroSoft</a> and first released in 2015.
F# started off as a research project aimed at making functional programming more accessible to mainstream developers. In 2010, F# was included in the Visual Studio 2010 release and in 2016, Microsoft made the F# compiler and core library open-source, with the community contributing to its development.
F# provides many features of functional programming languages such as immutability, higher-order functions, type inference and pattern matching. Additionally, it also supports object-oriented programming concepts like inheritance and encapsulation. This allows developers to write code that is both functional and object-oriented.
F# is also known for its interoperability with other .NET languages such as C# and Visual Basic. Developers can seamlessly integrate F# code into existing .NET projects and leverage the power of functional programming to solve complex problems.
F# has gained popularity in recent years, especially in the fields of finance and machine learning. The language is also widely used in academia for teaching functional programming concepts.
F# is in the top 30 of the <a href="https://www.tiobe.com/tiobe-index/">TIOBE index</a>. 

## Characteristics
- Paradigms:  <a href="https://en.wikipedia.org/wiki/Functional_programming">functional</a>, <a href="https://en.wikipedia.org/wiki/Object-oriented_programming">Object-oriented</a>, <a href="https://en.wikipedia.org/wiki/Imperative_programming">Imperative</a>, <a href="https://en.wikipedia.org/wiki/Concurrent_computing">Concurrent</a>.
- F# is a high level language
...
Go is in the top 10 of the <a href="https://www.tiobe.com/tiobe-index/">TIOBE index</a>. 
