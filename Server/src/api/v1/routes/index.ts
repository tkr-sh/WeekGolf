...
import {
  ...
  createContribution,
  editContribution,
  getCommentsContribution,
  getContribution,
  getContributions,
  getVotesCommentsContribution,
  getVotesInContributions,
...
router.get("/api/v1/versions", rate1m8req, getVersions);
// User
...
router.post(
  "/api/v1/vote-comment-contribution",
  authObligatory,
  rate1m32req,
  rate1h256req,
  voteCommentContribution,
...
router.get(
  "/api/v1/votes-contribution-comments",
  authObligatory,
  rate1m32req,
  rate1h256req,
  getVotesCommentsContribution,
