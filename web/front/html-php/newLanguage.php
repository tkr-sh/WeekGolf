    ...
    <body style="height: 100%">  
        ...
        <script>
            function upvoteLang(n){
                ...
                document.getElementsByClassName("textUpvote")[n].textContent = parseInt(document.getElementsByClassName("textUpvote")[n].textContent.split(" ")[0])+(b?1:-1)+" vote"+((parseInt(document.getElementsByClassName("textUpvote")[n].textContent.split(" ")[0])+(b?1:-1))<2?"":"s");
